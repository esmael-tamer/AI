...
CREATE TABLE IF NOT EXISTS stores (
  ...
  status VARCHAR(20) NOT NULL DEFAULT 'draft' CHECK (status IN ('draft', 'demo', 'pending', 'live', 'suspended')),
...
CREATE TABLE IF NOT EXISTS leads (
  ...
  email VARCHAR(255),
  country VARCHAR(50),
  type VARCHAR(30) NOT NULL DEFAULT 'store_activation' CHECK (type IN ('store_activation', 'ads_launch', 'account_mgmt')),
...
CREATE TABLE IF NOT EXISTS tickets (
  ...
  type VARCHAR(30) NOT NULL CHECK (type IN ('payments', 'shipping', 'warehousing', 'ads_launch_request', 'account_management_request')),
